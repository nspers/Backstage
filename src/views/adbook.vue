    ...
    export default {
                            ...
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.$Common.waring(()=>{
                                                this.$api.post(`/addressManagement/deleteAddressManagement/${params.row.id}`,{})
                                                    .then(res => {
        ...
        methods:{
            getAdlistData(){
                this.loading = true;
                this.adList = [];
                this.$api.post("/addressManagement/findAddressManagement",{
            ...
            ok () {
                if(this.which === 'add'){
                    this.$refs.formItem.validate((valid) => {
                        if (valid) {
                            this.$api.post("/addressManagement/insertAddressManagement", {
                    ...
                    this.$refs.formItem.validate((valid) => {
                        if (valid) {
                            this.$api.post("/addressManagement/updateAddressManagement",{
                                "id": this.formItem.id,
                                "name": this.formItem.name,
                                "telephone": this.formItem.telephone
                            }).then(res => {
