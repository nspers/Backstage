    ...
    <div class="leftNav" :class="{ 'active': count }">
      ...
      >
        <Submenu name="1">
          ...
          <MenuItem name="site">站点管理</MenuItem>
        </Submenu>
        <Submenu name="2">
          <template slot="title">
          ...
          <MenuItem name="loopsetting">回路配置</MenuItem>
        </Submenu>
        <Submenu name="3">
          <template slot="title">
          ...
          <MenuItem  name="lcd">LCD</MenuItem>
        </Submenu>
        <!-- <Submenu name="4">
          <template slot="title">
  ...
  methods: {
      getSubPath(){
          this.$nextTick(()=>{
            ...
            $('.ivu-menu-child-item-active li').removeClass('ivu-menu-item-active ivu-menu-item-selected')
            $('.ivu-menu-child-item-active li').eq(0).addClass('ivu-menu-item-active ivu-menu-item-selected')
          })
      },
    change_sub_router(e) {
      console.log(e);
