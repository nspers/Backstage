        ...
        },
        {
            ...
            children: [{
                ...
                },
                {
                    ...
                    name: 'loopsetting',
                    parent: '设备管理',
                    component: (resolve) => require(['@/views/loopsetting'], resolve)
                },
...
router.beforeEach((to, form, next) => {
    ...
    if (to.path != '/login') {
        if (sessionStorage.loginGJZBC != undefined && sessionStorage.loginGJZBC == 'true') {
            next()
        } else {
            next('/login')
        }
    } else if (sessionStorage.loginGJZBC != undefined && sessionStorage.loginGJZBC == 'true') {
        next('/deploy')
    } else {
        next()
    }
